...
function SearchPageContent() {
  ...
  function isSameEnvironment(url: string): boolean {
    const isInIOTAEnvironment = baseUrl === '/';
    const isEnvironmentSubroute = ['/shimmer/', '/next/'].some(subroute => url.startsWith(subroute));
    const isSameBase = url.startsWith(baseUrl);

    return (isInIOTAEnvironment && !isEnvironmentSubroute) || (!isInIOTAEnvironment && isSameBase);
  }
